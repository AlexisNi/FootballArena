...
class _View_HeaderComponent0 extends import1.AppView<import3.HeaderComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._text_9 = this.renderer.createText(this._el_8,' Authentication',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import10.RouterLinkActive) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) { return this._RouterLinkActive_7_3; }
    return notFoundResult;
  }
...
export function viewFactory_HeaderComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.HeaderComponent> {
  if ((renderType_HeaderComponent === (null as any))) { (renderType_HeaderComponent = viewUtils.createRenderComponentType('C:/Users/alex/WebstormProjects/footbalQuiz/assets/app/header.component.ts class HeaderComponent - inline template',0,import8.ViewEncapsulation.None,styles_HeaderComponent,{})); }
