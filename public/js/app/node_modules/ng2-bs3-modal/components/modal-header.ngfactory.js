...
import * as import3 from 'ng2-bs3-modal/components/modal-header';
...
export var ModalHeaderComponentNgFactory = new import10.ComponentFactory('modal-header', viewFactory_ModalHeaderComponent_Host0, import3.ModalHeaderComponent);
...
export function viewFactory_ModalHeaderComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ModalHeaderComponent === null)) {
        (renderType_ModalHeaderComponent = viewUtils.createRenderComponentType('C:/Users/alex/WebstormProjects/footbalQuiz/node_modules/ng2-bs3-modal/components/modal-header.d.ts class ModalHeaderComponent - inline template', 1, import9.ViewEncapsulation.None, styles_ModalHeaderComponent, {}));
    }
