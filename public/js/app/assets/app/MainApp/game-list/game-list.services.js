...
export var GameListServices = (function () {
    ...
    GameListServices.prototype.getResult = function (arenaUserInfo) {
        ...
        return this.http.post(myGlobals.host + 'questionANS/getResults', body, { headers: headers })
            ...
            var WinnerResult = new PlayerResult(winner._id, winner.lastName, loser._id, loser.lastName, Awards.awards.winner, Awards.awards.loser, Awards.awards.draw, response.json().draw);
            return WinnerResult;
        })
