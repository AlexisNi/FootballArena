...
var _View_HeaderComponent0 = (function (_super) {
    ...
    _View_HeaderComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_9 = this.renderer.createText(this._el_8, ' Authentication', null);
    ...
    _View_HeaderComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import10.RouterLinkActive) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) {
...
export function viewFactory_HeaderComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_HeaderComponent === null)) {
        (renderType_HeaderComponent = viewUtils.createRenderComponentType('C:/Users/alex/WebstormProjects/footbalQuiz/assets/app/header.component.ts class HeaderComponent - inline template', 0, import8.ViewEncapsulation.None, styles_HeaderComponent, {}));
    }
