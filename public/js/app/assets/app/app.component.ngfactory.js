...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._RouterOutlet_2_5 = new import12.RouterOutlet(this.parentInjector.get(import15.RouterOutletMap), this._appEl_2.vcRef, this.parentInjector.get(import16.ComponentFactoryResolver), null);
        this.init([], [
            this._el_0,
            this._text_1,
            this._el_2
