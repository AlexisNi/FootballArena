...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        this._RouterOutlet_0_5 = new import11.RouterOutlet(this.parentInjector.get(import12.RouterOutletMap), this._appEl_0.vcRef, this.parentInjector.get(import13.ComponentFactoryResolver), null);
        this.init([], [this._el_0], [], []);
        return null;
    };
    _View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import11.RouterOutlet) && (0 === requestNodeIndex))) {
...
export function viewFactory_AppComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AppComponent === null)) {
        (renderType_AppComponent = viewUtils.createRenderComponentType('C:/Users/alex/WebstormProjects/footbalQuiz/assets/app/app.component.html', 0, import8.ViewEncapsulation.Emulated, styles_AppComponent, {}));
    }
