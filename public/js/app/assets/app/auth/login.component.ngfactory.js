...
var _View_LoginComponent_Host0 = (function (_super) {
    ...
    _View_LoginComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('quiz-signin', rootSelector, null);
...
function viewFactory_LoginComponent_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_LoginComponent_Host === null)) {
        (renderType_LoginComponent_Host = viewUtils.createRenderComponentType('', 0, import10.ViewEncapsulation.None, [], {}));
    }
    return new _View_LoginComponent_Host0(viewUtils, parentInjector, declarationEl);
}
export var LoginComponentNgFactory = new import11.ComponentFactory('quiz-signin', viewFactory_LoginComponent_Host0, import3.LoginComponent);
...
var _View_LoginComponent0 = (function (_super) {
    ...
    _View_LoginComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_5 = this.renderer.createText(this._el_4, 'Welcome to Football quiz', null);
        ...
        this._text_13 = this.renderer.createText(this._el_12, 'Mail', null);
        ...
        this._FormControlName_15_5 = new import15.FormControlName(this._ControlContainer_2_4, null, null, this._NG_VALUE_ACCESSOR_15_4);
        ...
        this._FormControlName_23_5 = new import15.FormControlName(this._ControlContainer_2_4, null, null, this._NG_VALUE_ACCESSOR_23_4);
        ...
        this._el_34 = this.renderer.createElement(this._el_26, 'div', null);
        ...
        this._text_37 = this.renderer.createText(this._el_36, 'SignUp', null);
        ...
        var disposable_3 = this.renderer.listen(this._el_15, 'input', this.eventHandler(this._handle_input_15_0.bind(this)));
        var disposable_4 = this.renderer.listen(this._el_15, 'blur', this.eventHandler(this._handle_blur_15_1.bind(this)));
    ...
    _View_LoginComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import17.NG_VALUE_ACCESSOR) && (15 === requestNodeIndex))) {
            return this._NG_VALUE_ACCESSOR_15_4;
        }
        if (((token === import15.FormControlName) && (15 === requestNodeIndex))) {
            return this._FormControlName_15_5;
        }
        if (((token === import18.NgControl) && (15 === requestNodeIndex))) {
            return this._NgControl_15_6;
        }
        if (((token === import13.NgControlStatus) && (15 === requestNodeIndex))) {
        ...
        if (((token === import12.FormGroupDirective) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 40)))) {
            return this._FormGroupDirective_2_3;
        }
        if (((token === import19.ControlContainer) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 40)))) {
            return this._ControlContainer_2_4;
        }
        if (((token === import13.NgControlStatusGroup) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 40)))) {
    ...
    _View_LoginComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if ((changes !== null)) {
            this._FormControlName_15_5.ngOnChanges(changes);
        }
        changes = null;
        ...
        var currVal_26 = this._NgControlStatus_23_7.ngClassValid;
        ...
        var currVal_27 = this._NgControlStatus_23_7.ngClassInvalid;
    ...
    _View_LoginComponent0.prototype._handle_ngSubmit_2_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.onSubmit() !== false);
        return (true && pd_0);
    };
    _View_LoginComponent0.prototype._handle_submit_2_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._FormGroupDirective_2_3.onSubmit() !== false);
        return (true && pd_0);
    };
    _View_LoginComponent0.prototype._handle_reset_2_2 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._FormGroupDirective_2_3.onReset() !== false);
        return (true && pd_0);
    };
    _View_LoginComponent0.prototype._handle_input_15_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_15_3.onChange($event.target.value) !== false);
        return (true && pd_0);
    };
    _View_LoginComponent0.prototype._handle_blur_15_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_15_3.onTouched() !== false);
        return (true && pd_0);
    };
    _View_LoginComponent0.prototype._handle_input_23_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_23_3.onChange($event.target.value) !== false);
        return (true && pd_0);
    };
    _View_LoginComponent0.prototype._handle_blur_23_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
...
export function viewFactory_LoginComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_LoginComponent === null)) {
        (renderType_LoginComponent = viewUtils.createRenderComponentType('C:/Users/alex/WebstormProjects/footbalQuiz/assets/app/auth/login.component.html', 0, import10.ViewEncapsulation.None, styles_LoginComponent, {}));
    }
