...
var _View_LogoutComponent0 = (function (_super) {
    ...
    _View_LogoutComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this.renderer.setElementAttribute(this._el_2, 'class', 'btb btn-danger');
    ...
    _View_LogoutComponent0.prototype._handle_click_2_0 = function ($event) {
...
export function viewFactory_LogoutComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_LogoutComponent === null)) {
        (renderType_LogoutComponent = viewUtils.createRenderComponentType('C:/Users/alex/WebstormProjects/footbalQuiz/assets/app/auth/logout.component.ts class LogoutComponent - inline template', 0, import10.ViewEncapsulation.None, styles_LogoutComponent, {}));
    }
