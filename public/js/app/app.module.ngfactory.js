...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RootRenderer_26", {
        get: function () {
            if ((this.__RootRenderer_26 == null)) {
                (this.__RootRenderer_26 = import51._createConditionalRootRenderer(this._DomRootRenderer_25, this.parent.get(import51.NgProbeToken, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_43", {
        get: function () {
            if ((this.__LocationStrategy_43 == null)) {
                (this.__LocationStrategy_43 = import7.provideLocationStrategy(this.parent.get(import52.PlatformLocation), this.parent.get(import53.APP_BASE_HREF, null), this._ROUTER_CONFIGURATION_42));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ROUTER_FORROOT_GUARD_5 = import7.provideForRootGuard(this.parent.get(import61.Router, null));
        ...
        this._ApplicationRef__15 = new import12.ApplicationRef_(this.parent.get(import50.NgZone), this.parent.get(import62.Console), this, this._ErrorHandler_12, this, this._ApplicationInitStatus_13, this.parent.get(import11.TestabilityRegistry, null), this._Testability_14);
